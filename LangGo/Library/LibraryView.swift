...
private struct LibraryMetrics {
    ...
    init(screenSize: CGSize) {
        ...
        segmentFont = scaled(15)
        segmentBadgeFont = scaled(12)
        filterLabelFont = scaled(16)
        filterIconFont = scaled(16)
        tagFont = scaled(14)
        cardTitleFont = scaled(20)
        cardMetaFont = scaled(16)
        progressLabelFont = scaled(16)
        progressValueFont = scaled(16)
        badgeFont = scaled(14)
        iconFont = scaled(20)
        buttonFont = scaled(18)
